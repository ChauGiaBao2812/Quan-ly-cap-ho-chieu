    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CCCD = table.Column<byte[]>(type: "varbinary(256)", maxLength: 256, nullable: false),
                    HoTen = table.Column<byte[]>(type: "varbinary(256)", maxLength: 256, nullable: false),
                    GioiTinh = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    NgaySinh = table.Column<DateTime>(type: "datetime2", nullable: false),
                    NoiSinh = table.Column<byte[]>(type: "varbinary(256)", maxLength: 256, nullable: false),
                    NgayCap = table.Column<DateTime>(type: "datetime2", nullable: false),
                    NoiCap = table.Column<byte[]>(type: "varbinary(256)", maxLength: 256, nullable: false),
                    ...
                    SĐT = table.Column<byte[]>(type: "varbinary(128)", maxLength: 128, nullable: false),
                    ttTinhThanh = table.Column<byte[]>(type: "varbinary(256)", maxLength: 256, nullable: false),
                    ttQuanHuyen = table.Column<byte[]>(type: "varbinary(256)", maxLength: 256, nullable: false),
                    ttPhuongXa = table.Column<byte[]>(type: "varbinary(256)", maxLength: 256, nullable: false),
                    ttSoNhaDuong = table.Column<byte[]>(type: "varbinary(256)", maxLength: 256, nullable: false),
                    thtTinhThanh = table.Column<byte[]>(type: "varbinary(256)", maxLength: 256, nullable: false),
                    thtQuanHuyen = table.Column<byte[]>(type: "varbinary(256)", maxLength: 256, nullable: false),
                    thtPhuongXa = table.Column<byte[]>(type: "varbinary(256)", maxLength: 256, nullable: false),
                    thtSoNhaDuong = table.Column<byte[]>(type: "varbinary(256)", maxLength: 256, nullable: false),
                    HoTenCha = table.Column<byte[]>(type: "varbinary(256)", maxLength: 256, nullable: true),
                    NgaySinhCha = table.Column<DateTime>(type: "datetime2", nullable: true),
                    HoTenMe = table.Column<byte[]>(type: "varbinary(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MatKhau = table.Column<byte[]>(type: "varbinary(64)", maxLength: 64, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    thtPhuongXa = table.Column<byte[]>(type: "varbinary(256)", maxLength: 256, nullable: false),
                    thtSoNhaDuong = table.Column<byte[]>(type: "varbinary(256)", maxLength: 256, nullable: false),
                    NgheNghiep = table.Column<byte[]>(type: "varbinary(256)", maxLength: 256, nullable: true),
                    CoQuan = table.Column<byte[]>(type: "varbinary(256)", maxLength: 256, nullable: true),
                    DiaChiCoQuan = table.Column<byte[]>(type: "varbinary(256)", maxLength: 256, nullable: true),
                    HoTenCha = table.Column<byte[]>(type: "varbinary(256)", maxLength: 256, nullable: true),
                    NgaySinhCha = table.Column<DateTime>(type: "datetime2", nullable: true),
                    HoTenMe = table.Column<byte[]>(type: "varbinary(256)", maxLength: 256, nullable: true),
                    NgaySinhMe = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SĐT = table.Column<byte[]>(type: "varbinary(128)", maxLength: 128, nullable: false),
                    Email = table.Column<byte[]>(type: "varbinary(256)", maxLength: 256, nullable: false),
